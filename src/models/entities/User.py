...
from src.models.ContactsModel import ContactsModel
...
class Default_user(User):
    ...
    def show(self, search='', sort='', typeSort='', obj_filters={}):
        ...
        columns = [
            ...
            'email',
            'phone',
        ]  # ограничиваю доступную информацию
    ...
    def add_contact(self, new_contact):
        ...
        if new_contact.holder and not new_contact.holder == self.userId:
            'Недопустимое значение "holder"! Укажите свой id клиента или не используйте в запросе.'
    ...
    def update_contact(self, contact_id, dict_parametrs):
        ...
        if 'holder_id' in dict_parametrs:
            return 'Операция недоступна для пользователя со стандартными правами.'
